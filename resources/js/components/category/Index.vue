        ...
        <table class="table table-responsive">
            ...
            <tbody>
                <tr v-for="category in categories" :key="category.id">
                    ...
                    <td>
                      <a :href="category.home_image" target="_blank">
                        <img :src="category.home_image" :alt="category.name" width="50">
                      </a>
                    </td>
                    <td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="categoryModalLabel">{{ modalType === 'create' ? 'Crear Categoria' : 'Editar Categoria' }}</h5>
