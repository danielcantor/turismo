    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-xl-4 col-6">
                <h5 class='text-light fw-bold'>Accesos</h5>
                <ul class='ps-0'>
            ...
            <div class="col-xl-4 col-6 text-light">
                ...
                <ul class='ps-0'>
                    <li class="list-group-item mt-3 align-middle fw-light"><img src="/img/icons/ubi.svg" width='6.5%'> Buenos Aires , Argentina </li>
                </ul>
            </div>
            <div class="col-12 text-light text-center">
                ...
                <p class="list-group-item mb-0 align-middle fw-light "> Si necesita hacer un reclamo puede hacerlo ingresando <a class="text-decoration-none text-light" href="https://www.argentina.gob.ar/servicio/presentar-una-denuncia-contra-una-agencia-de-viajes" target="_blank" rel="noopener noreferrer">aca</a> </p>
