                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <ul style="margin: 0px; color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word; font-size: 18px; font-weight: 400;">
                                                                <li>Nombre: {{ $billingName }}</li>
                                                                <li>Dirección: {{ $billingAddress }}</li>
                                                                <li>Ciudad: {{ $billingCity }}</li>
                                                                <li>País: {{ $billingCountry }}</li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:arial,helvetica,sans-serif;" align="left">
                                                            ...
                                                            <ul style="margin: 0px; color: #ffffff; line-height: 160%; text-align: center; word-wrap: break-word; font-size: 18px; font-weight: 400;">
                                                                ...
                                                                <li>Cantidad: {{ $productQuantity }}</li>
                                                                <li>Precio: {{ $productPrice }}</li>
                                                            </ul>
                                                        </td>
                                                    </tr>
                                                    <tr>
