...
table, td { color: #000000; } @media (max-width: 480px) { #u_column_1 .v-col-border { border-top: 10px solid #e8eae9 !important;border-left: 10px solid #e8eae9 !important;border-right: 10px solid #e8eae9 !important;border-bottom: 10px solid #e8eae9 !important; } #u_content_heading_1 .v-font-size { font-size: 20px !important; } #u_row_2 .v-row-background-image--inner { background-position: right top !important; background-repeat: no-repeat !important; } #u_row_2 .v-row-background-image--outer { background-position: right top !important; background-repeat: no-repeat !important; } #u_row_2.v-row-background-image--outer { background-position: right top !important; background-repeat: no-repeat !important; } #u_column_6 .v-col-border { border-top: 0px solid transparent !important;border-left: 30px solid #e8eae9 !important;border-right: 30px solid #e8eae9 !important;border-bottom: 30px solid #e8eae9 !important; } #u_content_text_2 .v-container-padding-padding { padding: 20px 10px !important; } }
    </style>
...
<!--[if (mso)|(IE)]><td align="center" width="510" class="v-col-border" style="background-color: #268e92;width: 510px;padding: 0px;border-top: 40px solid #e8eae9;border-left: 45px solid #e8eae9;border-right: 45px solid #e8eae9;border-bottom: 10px solid #e8eae9;" valign="top"><![endif]-->
<div id="u_column_1" class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  ...
  <!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 40px solid #e8eae9;border-left: 45px solid #e8eae9;border-right: 45px solid #e8eae9;border-bottom: 10px solid #e8eae9;"><!--<![endif]-->
...
<!--[if (mso)|(IE)]></td><![endif]-->
    ...
    <!--[if gte mso 9]>
      <table cellpadding="0" cellspacing="0" border="0" style="margin: 0 auto;min-width: 320px;max-width: 600px;">
        <tr>
          <td background="https://cdn.templates.unlayer.com/assets/1693478073309-Layer%201%201.png" valign="top" width="100%">
      <v:rect xmlns:v="urn:schemas-microsoft-com:vml" fill="true" stroke="false" style="width: 600px;">
        <v:fill type="frame" src="https://cdn.templates.unlayer.com/assets/1693478073309-Layer%201%201.png" /><v:textbox style="mso-fit-shape-to-text:true" inset="0,0,0,0">
      <![endif]-->
  
<div id="u_row_2" class="u-row-container v-row-background-image--outer" style="padding: 0px;background-image: url('images/image-2.png');background-repeat: no-repeat;background-position: center top;background-color: transparent">
  <div class="u-row" style="margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
    <div class="v-row-background-image--inner" style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
...
<div class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  <div style="background-color: #e8eae9;height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
  <!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
...
<!--[if (mso)|(IE)]><td align="center" width="486" class="v-col-border" style="background-color: #ffffff;width: 486px;padding: 0px;border-top: 0px solid transparent;border-left: 57px solid #e8eae9;border-right: 57px solid #e8eae9;border-bottom: 50px solid #e8eae9;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;" valign="top"><![endif]-->
<div id="u_column_6" class="u-col u-col-100" style="max-width: 320px;min-width: 600px;display: table-cell;vertical-align: top;">
  ...
  <!--[if (!mso)&(!IE)]><!--><div class="v-col-border" style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 57px solid #e8eae9;border-right: 57px solid #e8eae9;border-bottom: 50px solid #e8eae9;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;"><!--<![endif]-->
...
<table id="u_content_text_2" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div class="v-font-size" style="font-size: 14px; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="line-height: 140%;"><span data-metadata="&lt;!--(figmeta)eyJmaWxlS2V5IjoiWjZ3Tk96Slh3VVQ1RkNGZHVna0FmQSIsInBhc3RlSUQiOjk1NTY3NzE3OCwiZGF0YVR5cGUiOiJzY2VuZSJ9Cg==(/figmeta)--&gt;" style="line-height: 19.6px;"></span>
    <span>
        Nombre: 
    </span>
    </p>
