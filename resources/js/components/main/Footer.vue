    ...
    <div class="container py-5">
        <div class="row">
            ...
            <div class="col-12 text-light text-center">
                ...
                <p class="align-middle fw-light mb-0">Leg 18.761 - Disp 2182/72</p>
                ...
                <p class="align-middle fw-light mb-0"><a href="https://buenosaires.gob.ar/defensaconsumidor/direccion-general" target="_blank" rel="noopener noreferrer">Dirección General de Defensa y Protección al Consumidor</a></p>
            </div>
        </div>
    </div>
</footer>
